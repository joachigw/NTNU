...
public class PlayingCard {
    ...
    private final int face; // A number between 1 and 13 (inclusively)
     ...
     * @param imageView The ImageView used to display an image of the card.
     */
    public PlayingCard(char suit, int face, ImageView imageView) {

        if(suit == ' ') {
            throw new IllegalArgumentException("The suit cannot be an empty character.");
        }
        if(face < 0 || face > 13) {
            throw new IllegalArgumentException("The suit cannot be less than 0, nor higher than 13.");
        }
        this.suit = suit;
        this.face = face;
    ...
    /**
     * Return the ImageView used to display the card.
     *
